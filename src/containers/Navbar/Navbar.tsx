...
import { ModalNavigation } from 'unicial-ui/dist/components/ModalNavigation/ModalNavigation'
import { Navbar as NavbarComponent, NavbarI18N } from 'unicial-ui/dist/components/Navbar/Navbar'
  ...
  getTranslations = (): NavbarI18N | undefined => {
    ...
    return {
      menu: {
        ...
        home: <T id="@dapps.navbar.menu.home" />
      },
      account: {
